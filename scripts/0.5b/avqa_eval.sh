...
VISION_ADAPTER_PATH=${VISION_ADAPTER_PATH:-./checkpoints/LynX_0.5b/audio/avqa/train}
LLM_ADAPTER_PATH=${LLM_ADAPTER_PATH:-./checkpoints/LynX_0.5b/audio/avqa/sft}

OUTPUT_DIR=${OUTPUT_DIR:-./downstream_evaluation/audio}
PRED_SAVE=${PRED_SAVE:-$OUTPUT_DIR/avqa_eval/avqa_predictions.json}
