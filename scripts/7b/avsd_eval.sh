...
VISION_ADAPTER_PATH=${VISION_ADAPTER_PATH:-./checkpoints/LynX_7b/audio/avsd/train}
LLM_ADAPTER_PATH=${LLM_ADAPTER_PATH:-./checkpoints/LynX_7b/audio/avsd/sft}

OUTPUT_DIR=${OUTPUT_DIR:-./downstream_evaluation/audio}
PRED_SAVE=${PRED_SAVE:-$OUTPUT_DIR/avsd_eval/avsd_predictions.json}

DEEPSPEED_CONFIG=${DEEPSPEED_CONFIG:-./scripts/zero2.json}
MASTER_PORT=${MASTER_PORT:-60070}
