...
VISION_ADAPTER_PATH=${VISION_ADAPTER_PATH:-./checkpoints/LynX_7b/audio/music_avqa/train}
LLM_ADAPTER_PATH=${LLM_ADAPTER_PATH:-./checkpoints/LynX_7b/audio/music_avqa/sft}

OUTPUT_DIR=${OUTPUT_DIR:-./downstream_evaluation/audio}
PRED_SAVE=${PRED_SAVE:-$OUTPUT_DIR/music_avqa_eval/music_avqa_predictions.json}

DEEPSPEED_CONFIG=${DEEPSPEED_CONFIG:-./scripts/zero2.json}
MASTER_PORT=${MASTER_PORT:-60080}
