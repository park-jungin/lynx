...
## this following version is adaptored from llava_onevision
conv_llava_ov_qwen = Conversation(
    system="""<|im_start|>system
You are a helpful assistant.""",
...
conv_templates = {
    ...
    "mpt": conv_mpt,
    "Qwen2Tokenizer": conv_Qwen2Tokenizer,
    "Qwen2TokenizerV2": conv_Qwen2TokenizerV2,   
    "conv_llava_ov_qwen": conv_llava_ov_qwen, 
}
